...
public class Subtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameContinue();
        startTimer();
        Toast.makeText(Subtraction.this,"GO TO 80 SCORE!!!",Toast.LENGTH_LONG).show();
        ...
        okayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                okaybtn.start();
                if (!editAnswer.getText().toString().matches("")) {
                    //Eger bos tiklanirsa
                    ...
                    if (userAnswer == realAnswer) {
                        ...
                        if (userScore >= 0 && userScore < 100) {
                            Toast.makeText(Subtraction.this,"GO TO 180 SCORE!!!",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 100 && userScore < 200) {
                            Toast.makeText(Subtraction.this,"GO TO 260 SCORE!!!",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 200 && userScore < 300) {
                            Toast.makeText(Subtraction.this,"GO TO 350 SCORE!!!",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 350 && userScore < 360) {
                            Toast.makeText(Subtraction.this,"GO TO 450 SCORE!!!",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 450 && userScore < 460) {
                            Toast.makeText(Subtraction.this,"GO TO 600 SCORE!!!",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 600 && userScore < 610) {
                            Toast.makeText(Subtraction.this,"FINISH LEVEL GO TO 1000 SCORE",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userScore >= 800 && userScore < 810) {
                            Toast.makeText(Subtraction.this,"YOU ARE BEST ",Toast.LENGTH_LONG).show();
                            pauseTimer();
                            resetTimer();
                            startTimer();
                            userLife = 3;
                        ...
                        if (userLife == 0) {
                            pauseTimer();
                            Toast.makeText(Subtraction.this, "Game Over", Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(Subtraction.this, Result.class);
                            intent.putExtra("score", userScore);
                            startActivity(intent);
                            Animatoo.animateZoom(Subtraction.this);
                            finish();
                        }
                    }
                    gameContinue();
    ...
    public void gameContinue() {
        do {
            sayi1 = random.nextInt(100) + 10;
            sayi2 = random.nextInt(100) + 10;
        }
        while (sayi1-sayi2 <= 0);
    ...
    public void startTimer() {
        ...
        timer = new CountDownTimer(time_left_in_mills, 1000) {
            ...
            public void onFinish() {
                ...
                intent.putExtra("score", userScore);
                startActivity(intent);
                Animatoo.animateShrink(Subtraction.this);
                finish();
            }
        }.start();
